 ...
 function prevFrame() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 sm:py-12">
      ...
      <h2 className="text-xl sm:text-3xl font-bold mb-4 sm:mb-6 text-blue-700"> Edit Play </h2> {/* Title Size */}
      ...
      <div className="mt-6 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
              ...
              <div className="flex items-center justify-start sm:justify-end gap-2 sm:gap-3 mt-4 sm:mt-0 w-full sm:w-auto order-3 sm:order-3"> {/* Added mt-4 sm:mt-0 */}
                  <button onClick={handlePlayToggle} className="px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg bg-emerald-600 text-white hover:bg-emerald-700 text-sm sm:text-base" disabled={frames.length < 2} title={ frames.length < 2 ? "Add at least 2 frames to play" : "" }> {isPlaying ? "Pause" : "Play"} </button>
      ...
      {/* Reduced top margin on mobile for Privacy Toggle */}
       <div className="mt-2 sm:mt-8 flex items-center justify-start gap-3"> {/* mt-2 sm:mt-8 */}
